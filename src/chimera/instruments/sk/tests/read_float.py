...
ip='192.168.30.105' #change to the corresponding ip number of your network installed commander SK
...
#starting connecetion

sk=ModbusTcpClient(ip)
if sk.connect():
    result  = sk.read_holding_registers(2107, 4)
    decoder = BinaryPayloadDecoder.fromRegisters(result.registers, endian=Endian.Little)
    string_result=str(decoder.decode_32bit_float())
    print "read_holding_registers: " + string_result
